...
@section('container')
    <p class="fw-bold fs-2 py-2">Permintaan Penjemputan</p>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                        ...
                        <div class="card-body d-flex">
                            ...
                            <div class="d-flex flex-column justify-content-between"> <!-- Menyamakan jarak text -->
                                <div class="px-3 text-dark"> <!-- Mengurangi padding horizontal -->
                                    <h5 class="card-title fw-semibold mt-2 mb-0">Fauzan Adi Pratama</h5>
                ...
                <div class="card mb-4" style="max-width: 100%; background-color: #9BDCBD;"> <!-- Mengatur lebar maksimum card dan margin -->
                    <a href="/detail" class="text-decoration-none">
                        <div class="card-body d-flex">
                            ...
                            <div class="px-3 text-dark"> <!-- Mengurangi padding horizontal -->
                                <h5 class="card-title fw-semibold mt-2 mb-0">Nanda Putri Indah</h5>
                ...
                <div class="card mb-4" style="max-width: 100%; background-color: #9BDCBD;"> <!-- Mengatur lebar maksimum card dan margin -->
                    <a href="/detail" class="text-decoration-none">
                        <div class="card-body d-flex">
                            <img src="/img/cowok.jpg" alt="Gambar" class="rounded-circle mr-3" style="width: 100px; height: 100px;"> <!-- Mengatur ukuran gambar -->
                            <div class="px-3 text-dark"> <!-- Mengurangi padding horizontal -->
                               <h5 class="card-title fw-semibold mt-2 mb-0">Gilang Bayu Nugraha</h5>
                                    <p class="card-text mt-2 mb-0">3 KM</p>
                ...
                <div class="card mb-4" style="max-width: 100%; background-color: #9BDCBD;"> <!-- Mengatur lebar maksimum card dan margin -->
                    <a href="/detail" class="text-decoration-none">
                        <div class="card-body d-flex">
                            <img src="/img/cewek.jpg" alt="Gambar" class="rounded-circle mr-3" style="width: 100px; height: 100px;"> <!-- Mengatur ukuran gambar -->
                            <div class="px-3 text-dark"> <!-- Mengurangi padding horizontal -->
                               <h5 class="card-title fw-semibold mt-2 mb-0">Rina Dwi Lestari</h5>
                                    <p class="card-text mt-2 mb-0">2 KM</p>
                ...
                <div class="card mb-4" style="max-width: 100%; background-color: #9BDCBD;"> <!-- Mengatur lebar maksimum card dan margin -->
                    <a href="/detail" class="text-decoration-none">
                        <div class="card-body d-flex">
                            <img src="/img/cewek.jpg" alt="Gambar" class="rounded-circle mr-3" style="width: 100px; height: 100px;"> <!-- Mengatur ukuran gambar -->
                            <div class="px-3 text-dark"> <!-- Mengurangi padding horizontal -->
                               <h5 class="card-title fw-semibold mt-2 mb-0">Cindy Ayu Sari</h5>
                                    <p class="card-text mt-2 mb-0">2 KM</p>
                ...
                <div class="card mb-4" style="max-width: 100%; background-color: #9BDCBD;"> <!-- Mengatur lebar maksimum card dan margin -->
                    <a href="/detail" class="text-decoration-none">
                        <div class="card-body d-flex">
                            <img src="/img/cowok.jpg" alt="Gambar" class="rounded-circle mr-3" style="width: 100px; height: 100px;"> <!-- Mengatur ukuran gambar -->
                            <div class="px-3 text-dark"> <!-- Mengurangi padding horizontal -->
                               <h5 class="card-title fw-semibold mt-2 mb-0">Rizky Ananta Putra</h5>
